...
Ciphertext<DCRTPoly> add(CryptoContext<DCRTPoly> cryptoContext, Ciphertext<DCRTPoly> arg1, Ciphertext<DCRTPoly> arg2){
    auto res = cryptoContext->EvalAdd(arg1, arg2);
    return res;
}
...
signed main(){
    ...
    {
        std::vector <int64_t> vectorA = {1, -1, 1, 0, 8368};
        std::vector <int64_t> vectorB = {1, 1, -1, -1, 12934};
        ...
        auto BGVaddAB = add(BGVContext, BGVCiphertextA, BGVCiphertextB);
        ...
        auto BFVaddAB = add(BFVContext, BFVCiphertextA, BFVCiphertextB);
        ...
        auto CKKSaddAB = add(CKKSContext, CKKSCiphertextC, CKKSCiphertextD);
